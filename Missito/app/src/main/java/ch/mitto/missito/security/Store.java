...
//    public void generateKeyInKeystore() throws NoSuchProviderException, NoSuchAlgorithmException, InvalidAlgorithmParameterException {
//        try {
...
//                    .setAlias(KEY_ALIAS)
//                    .setSubject(new X500Principal("CN=Sample Name, O=Missito"))
