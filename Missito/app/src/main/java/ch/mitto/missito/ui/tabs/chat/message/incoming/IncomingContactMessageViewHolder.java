...
public class IncomingContactMessageViewHolder extends IncomingMessageViewHolder {
    ...
    public IncomingContactMessageViewHolder(View itemView, CellActionListener listener) {
        super(itemView);
